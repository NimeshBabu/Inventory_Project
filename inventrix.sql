...
('1254', 'Bed', 50000.00, 60000.00, 'King Size Bed', 'https://lifely.com.au/cdn/shop/files/JoseBedFrameGallery1.jpg?v=1733883102', 1, 'ABC Company-1111'),
('1578', 'Study Table', 18000.00, 25000.00, 'Aesthetic', 'https://nativesutra.com/wp-content/uploads/2024/12/Screenshot_3-1.png', 5, 'ABC Company-1111'),
...
('5214', 'Kitchen Set', 100000.00, 1400000.00, 'Full set', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQwPLSjGDXg-yiQb2AurSMv_-fWd2zvSGFS-A&s', 27, 'Sunshine Traders-1357'),
...
(1231, '2025-03-11', '1221', 10, 300000.00, 'Paid', 'ABC Company-1111'),
(1232, '2025-03-20', '1221', 20, 600000.00, 'Paid', 'ABC Company-1111'),
(1233, '2025-03-18', '1221', 5, 150000.00, 'Paid', 'ABC Company-1111'),
...
(4, '2025-03-04', '1221', 'Ghanshyam ', 'Palpa', 'Biller A', 30, 1110000.00, 'Paid'),
(11, '2025-03-12', '1221', 'hari', 'Bhaktapur', 'Biller A', 5, 185000.00, 'Paid'),
(12, '2025-03-06', '1221', 'Ram ', 'Bhaktapur', 'Biller A', 10, 370000.00, 'Paid'),
(13, '2025-03-04', '1578', 'Ghanshyam ', 'Bhaktapur', 'Biller A', 5, 125000.00, 'Paid'),
(14, '2025-03-13', '1982', 'Ram ', 'Palpa', 'Biller B', 3, 105000.00, 'Paid');
...
(0, 'kritisha@1', '$2y$10$TJDtN2XtuyAudrH9Pfp5pOZr3dm82RG/teigRrDOY6bx5I/jNRTdG', '2025-03-24 14:15:48'),
(1, 'kritisha@123', '$2y$10$yLspMkzxEKjLeVQ4E9pwvOIFl0a/Q5DTWQDs7xnJeVX.nc8yA1pJq', '2025-03-23 15:09:22');
...
--
ALTER TABLE `purchase`
  MODIFY `PurchaseID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1238;
